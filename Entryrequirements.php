  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
	  ...
	  <div class="dropdown-menu">
        ...
        <a class="dropdown-item" href="Entryrequirements.php">Entry Requirements</a>
        <a class="dropdown-item" href="howtoapply.php">How to apply</a>
		<a class="dropdown-item" href="paymentoption.php">Payment Option</a>
      </div>
    </li>
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Courses</a>
	  <div class="dropdown-menu">
        <a class="dropdown-item" href="Courses.php">Academic Programmes and courses</a>
   ...
   <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="#">Bethel Contacts</a>
	...
	<li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="whybit.php">Why Choose Bethel Institute</a>
...
<!--<p>To join BIT to pursue a Certificate course, you must have a minimum of D in KCSE or Artisan Certificate. For Diploma programmes, you must have attained a minimum of C- or Certificate course in a recognize institution. Artisan courses require that a candidate has a minimum mean grade of E in KCSE or KCPE Certificate. Higher Diploma programmes, candidates must have attained a Diploma course or a Degree from a recognize institution.</p>-->

<div class="container">


<div class="tab-content" style="height: 550px;overflow: scroll;">
  <div class="tab-pane fade show active" id="home">
  <h2>Entry Requirements</h2>
   <p>To join BIT to pursue a Certificate course, you must have a minimum of D in KCSE or Artisan Certificate. For Diploma programmes, you must have attained a minimum of C- or Certificate course in a recognize institution. Artisan courses require that a candidate has a minimum mean grade of E in KCSE or KCPE Certificate. Higher Diploma programmes, candidates must have attained a Diploma course or a Degree from a recognize institution.</p></br>       
 
 <p>The following table is a summary of the requirements for courses offered:</p>
  ...
  <table class="table table-striped" style="height:20px">
	...
	<tbody> 
	 ...
	 <tr>
        ...
        <td>1</td>
		<td>Certificate</td>
		<td>Minimum KCSE mean grade of D or Artisan(proficiency certificate from a recognize institution</td>
        <td>1 Years</td>
	   ...
	   <tr>
        <td>2</td>
        <td>Diploma</td>
		<td>KCSE mean grade of C- or Certificate course from a recognize institution</td>
        <td>2 Years</td>
      </tr>
      ...
      <tr>
        <td>3</td>
        <td>Artisan</td>
		<td>Minimum KCSE mean grade of E or KCPE Certificate</td>
        <td>1 Years</td>
      </tr>
	  ...
	  <tr>
		...
		<td>Holders of Diploma or Degree from a recognize institution</td>
        <td>2 Years</td>
      </tr>
